...
Much of the literature on analysis and modeling of cycle count data has emerged from transport planning institutions [e.g. @lindsey_minnesota_2013], although there has been a recent uptick in academic papers on the subject [@dadashova_random_2020].
