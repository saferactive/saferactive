...
Preliminary findings suggest that new cycleways alone were not associated with safer roads for all modes but that places with addition 'low traffic neighbourhood' type interventions such as 'filtered permeability' and reduced speed limits saw substantial reductions in crash rates.
The findings provide a (still evolving) evidence base on which policy-relevant debates about the framing of active travel and road safety interventions can build.
