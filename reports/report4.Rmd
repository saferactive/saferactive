...
The next step is to investigate how these patterns relate to the distribution of road types. The total road length within each 1km grid cell varies greatly across the region, but so too does the distribution of types of road within each grid cell.
