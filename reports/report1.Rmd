...
Corrections were also made to account for changes in accident reporting systems. In recent years, police forces across the UK have switched to injury-based reporting systems. This has altered the proportions of casualties recorded as having 'severe' and 'slight' injuries. To control for these changes, casualty-level correction values were used, as recommended in XX.
