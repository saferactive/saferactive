...
Metrics to support this objective include: KSI/bkm and slightly casualties, urban/rural/regional split of crashes, and proportion of cyclists/drivers stating that it's too dangerous to cycle.
...
Section 6.1, focussed on infrastructure and road signs interventions, found that there is evidence for the effectiveness of a range of interventions can be effective in reducing casualty rates, including 'pedestrian refuge islands', speed humps and speed cameras.
...
There are still no legally binding national standards local authorities meaning that many cycleways do not meet guidance such as a 1.5 m minimum cycleway width.
...
- Speed limit reductions include '20 mph limits' (implemented only via signalling) and '20 mph zones' (which can include optional measures including speed cameras) [@maher_20mph_2018; @rospa_guide_2019]
...
- Traffic Regulation Orders reporting interventions such as one-way cycleway and other changes
  - Data on TROs should be available open access from https://www.thegazette.co.uk
- The location and nature of physical infrastructure, including 'filtered permeability' interventions including and rising and fixed bollards, and a range of speed humps, plus a range of additional traffic calming measures [@departmentfortransport_traffic_2007]. These can be obtained from multiple sources, including:
...
We have explored visualisation options.

Todo: Layik's bit on geoplumber here...
...
We have developed a methodology to estimate the crash rate per billion km for walking and cycling

Todo: Joey's bit here
