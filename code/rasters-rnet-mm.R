...
rnet_national_sf_27700 = rnet_national_sf_27700[,c("bicycle")]
rnet_national_sf_27700 = rnet_national_sf_27700[rnet_national_sf_27700$bicycle > 0,]


# split into straight line segments
rnet_split = fracture_line(rnet_national_sf_27700)
rnet_split$length <- as.numeric(st_length(rnet_split))
summary(rnet_split$length)
summary(rnet_split$length > 50)
summary(rnet_split$length > 100)
rnet_split = line_segment_sf(l = rnet_split[sample(1:nrow(rnet_split), 1000),], segment_length = 100)
